...
# ## NebulaFile
#
# We define a `GreatExpectationsTask` that validates a `NebulaFile`.
...
file_task_object = GreatExpectationsTask(
    name="great_expectations_task_nebulafile",
    datasource_name="data",
...
# ## NebulaSchema
#
# We define a `GreatExpectationsTask` that validates NebulaSchema.
...
schema_task_object = GreatExpectationsTask(
    ...
    datasource_name="data",
    inputs=kwtypes(dataset=NebulaSchema),
...
# %% [markdown]
# Let's fetch the DataFrame from the SQL Database we've with us. To do so, we use the `SQLite3Task` available within Nebula.
# %%
...
runtime_task_obj = GreatExpectationsTask(
    ...
    inputs=kwtypes(dataframe=NebulaSchema),
    expectation_suite_name="test.demo",
...
if __name__ == "__main__":
    ...
    print(simple_wf())
    print("Great Expectations Task with NebulaFile...")
    print(file_wf())
    print("Great Expectations Task with NebulaSchema...")
    print(schema_wf())
