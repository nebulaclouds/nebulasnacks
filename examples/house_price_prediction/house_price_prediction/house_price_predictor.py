...
#
# In this tutorial, we will understand how to predict house prices using XGBoost, and Nebula.
#
# We will split the generated dataset into train, test and validation set.
#
# Next, we will create three Nebula tasks, that will:
#
...
# ## Training
#
# We fit an `XGBRegressor` model on our data, serialize the model using `joblib`, and return a {py:obj}`~nebulakit:nebulakit.types.file.JoblibSerializedFile`.
# %%
