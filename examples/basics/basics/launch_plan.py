...
# in the project's nebulakit configuration (such as user role).
#
# To begin, import the necessary libraries.
# %%
from nebulakit import LaunchPlan, current_context
...
# %% [markdown]
# Attempting to modify the inputs will result in an error being raised by Nebula.
#
# :::{note}
