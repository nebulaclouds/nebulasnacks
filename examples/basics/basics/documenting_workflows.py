...
# Nebula enables the use of docstrings to document your code.
# Docstrings are stored in [NebulaAdmin](https://docs.nebula.org/en/latest/concepts/admin.html)
...
# :::{figure} https://raw.githubusercontent.com/nebulaclouds/static-resources/main/nebulasnacks/user_guide/document_wf_short.png
# :alt: Short description
# :class: with-shadow
# :::
#
# 2. If you click into the workflow, you'll see the long description in the basic information section:
# :::{figure} https://raw.githubusercontent.com/nebulaclouds/static-resources/main/nebulasnacks/user_guide/document_wf_long.png
