...
# ```
#
# By default, Nebula employs a standardized convention to assign names to the outputs of tasks or workflows.
...
#
# However, Nebula allows the customization of output names for tasks or workflows.
