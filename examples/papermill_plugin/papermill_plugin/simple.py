...
#
# In this example, we will show how to create a nebula task that runs a simple notebook, accepts one input variable, transforms it, and produces
...
from nebulakitplugins.papermill import NotebookTask
...
#
# ```{image} https://raw.githubusercontent.com/nebulaclouds/static-resources/main/nebulasnacks/user_guide/parameters.png
...
#
# ```{image} https://raw.githubusercontent.com/nebulaclouds/static-resources/main/nebulasnacks/user_guide/outputs.png
# :alt: Example of "parameters tag" added to the cell with input variables
# ```
#
...
# - You can see the notebook on Nebula deck if `render_deck` is set to true.
# :::
