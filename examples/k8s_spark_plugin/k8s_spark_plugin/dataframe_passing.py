...
#
# This example shows the process of returning a Spark dataset from a Nebula task
...
import nebulakit
import pandas
from nebulakit import ImageSpec, Resources, kwtypes, task, workflow
from nebulakit.types.structured.structured_dataset import StructuredDataset
...
# %%
custom_image = ImageSpec(name="nebula-spark-plugin", registry="ghcr.io/nebulaclouds")
...
# %% [markdown]
# To create a Spark task, add {py:class}`~nebulakitplugins.spark.Spark` config to the Nebula task.
#
...
# The Nebulakit type system handles the automatic conversion of the `pyspark.DataFrame` into a `StructuredDataset` object.
...
#
# - {ref}`Modin <Modin>`
# - [Vaex](https://github.com/nebulaclouds/nebulakit/blob/master/plugins/nebulakit-vaex/README.md)
# - [Polars](https://github.com/nebulaclouds/nebulakit/blob/master/plugins/nebulakit-polars/README.md)
