...
#
# As we learned in the {ref}`Nebula Fundamentals <containerizing_your_project>` guide,
# Nebula uses OCI-compatible containers to package up your code and third-party
...
#       2. Update `NebulaPropeller <https://github.com/nebulaclouds/nebulaplugins/blob/e2971efbefd9126aca0290ddc931663605dec348/go/tasks/pluginmachinery/nebulak8s/config/config.go#L157>`__ about the pod created in the previous step.
#       3. NebulaPropeller adds ``imagePullSecrets``, along with other customization for the pod,
