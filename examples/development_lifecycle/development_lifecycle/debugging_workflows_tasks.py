...
# │           └── URI :http://localhost:30082/#/log/nebulactldemo-development/f3a5a4034960f4aa1a09-n1-0/pod?namespace=nebulactldemo-development
# ```
#
# Additionally you can check the pods launched by nebula in \<project>-\<domain> namespace
#
# ```
