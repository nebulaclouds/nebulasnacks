...
# 3. Tensorboard Logs: We will also output a directory that contains Tensorboard compatible logs. Nebula will collect
...
#
# ```python
# HDF5EncodedModelFile = NebulaFile[typing.TypeVar("hdf5")]
# ```
#
# But this type alias is already available from Nebulakit's type engine, so it can just be imported.
# We will also import `PNGImageFile` which will be used in the next task:
# %%
from nebulakit.types.file import HDF5EncodedFile, PNGImageFile
from nebulakitplugins.awssagemaker import (
    AlgorithmName,
...
# is useful to have human readable names for the outputs. In the absence of this, nebulakit will name all outputs as
# `o0, o1, ...`
# %%
...
#
# ```
# Model: /tmp/nebula/20210110_214129/mock_remote/8421ae4d041f76488e245edf3f4360d5/my_model.h5, Accuracy PNG: /tmp/nebula/20210110_214129/mock_remote/cf6a2cd9d3ded89ed814278a8fb3678c/accuracy.png, loss PNG: /tmp/nebula/20210110_214129/mock_remote/267c9dd17d4d4e7c9c8bb8b12ef1e3d2/loss.png, Tensorboard Log Dir: /tmp/nebula/20210110_214129/mock_remote/a4b04e58e21f26f08f81df24094d6446/
# ```
#
# You can use the `Tensorboard Log Dir: /tmp/nebula/20210110_214129/mock_remote/a4b04e58e21f26f08f81df24094d6446/` as
...
# ```
#
# If running remotely (executing on Nebula hosted environment), the workflow execution outputs can be retrieved.
#
