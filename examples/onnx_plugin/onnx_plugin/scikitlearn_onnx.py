...
from nebulakit.types.file import ONNXFile
from nebulakitplugins.onnxscikitlearn import ScikitLearn2ONNX, ScikitLearn2ONNXConfig
...
# This is a special annotation that tells Nebulakit that this parameter is to be converted to an ONNX model with the given metadata.
# %%
