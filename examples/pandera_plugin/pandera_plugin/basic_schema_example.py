...
# to annotate dataframe inputs and outputs in your nebula tasks.
...
#
# Finally, we can turn our data processing pipeline into a Nebula workflow
# by decorating our functions with the {py:func}`~nebulakit.task` and {py:func}`~nebulakit.workflow` decorators and
