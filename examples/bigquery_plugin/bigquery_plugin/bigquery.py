...
# # BigQuery Query
#
# This example shows how to use a Nebula BigQueryTask to execute a query.
# %%
try:
...
import pandas as pd
from nebulakit import StructuredDataset, kwtypes, task, workflow
from nebulakitplugins.bigquery import BigQueryConfig, BigQueryTask

# %% [markdown]
# This is the world's simplest query. Note that in order for registration to work properly, you'll need to give your
# BigQuery task a name that's unique across your project/domain for your Nebula installation.
# %%
bigquery_task_no_io = BigQueryTask(
    name="sql.bigquery.no_io",
    inputs={},
    query_template="SELECT 1",
    task_config=BigQueryConfig(ProjectID="nebula"),
)
