        ...
        databricks_conf={
            ...
            "new_cluster": {
                ...
                "aws_attributes": {
                    ...
                    "instance_profile_arn": "arn:aws:iam::<AWS_ACCOUNT_ID_DATABRICKS>:instance-profile/databricks-nebula-integration",
                },
                "num_workers": 4,
            },
...
# %% [markdown]
# Additionally, we define a standard Nebula task that won't be executed on the Spark cluster.
# %%
