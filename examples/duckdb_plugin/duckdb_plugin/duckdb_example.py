...
from nebulakitplugins.duckdb import DuckDBQuery
...
# :::
#
# You can invoke the task from within a {py:func}`~nebulakit:nebulakit.workflow` and return both a Pandas dataframe and a PyArrow table.
