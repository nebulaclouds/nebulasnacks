...
import pandas as pd
from nebulakit import Resources, kwtypes, workflow
from nebulakitplugins.papermill import NotebookTask

# %% [markdown]
# We define a `NotebookTask` to run the [Jupyter notebook](https://github.com/nebulaclouds/nebulasnacks/blob/master/cookbook/case_studies/feature_engineering/eda/supermarket_regression_1.ipynb) (EDA).
...
# %% [markdown]
# We define a `NotebookTask` to run the [Jupyter notebook](https://github.com/nebulaclouds/nebulasnacks/blob/master/cookbook/case_studies/feature_engineering/eda/supermarket_regression_2.ipynb)
# (Modeling).
#
