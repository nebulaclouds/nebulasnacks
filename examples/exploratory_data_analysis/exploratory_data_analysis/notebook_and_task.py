# %% [markdown]
# # EDA and Feature Engineering in Jupyter Notebook and Modeling in a Nebula Task
#
...
# (step 2: Modeling in a Nebula Task).
...
# %% [markdown]
# We define a `NotebookTask` to run the [Jupyter notebook](https://github.com/nebulaclouds/nebulasnacks/blob/master/cookbook/case_studies/feature_engineering/eda/supermarket_regression_1.ipynb).
