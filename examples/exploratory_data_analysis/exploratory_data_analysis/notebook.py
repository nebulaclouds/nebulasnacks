# %% [markdown]
# # Nebula Pipeline in One Jupyter Notebook
#
...
# %% [markdown]
# We define a `NotebookTask` to run the [Jupyter notebook](https://github.com/nebulaclouds/nebulasnacks/blob/master/cookbook/case_studies/feature_engineering/eda/supermarket_regression.ipynb).
#
# ```{eval-rst}
