...
# Nebulakit will automatically convert it and constrain the inputs and outputs to the predefined set of values.
#
# :::{important}
# Currently, only string values are supported as valid enum values.
# Nebula assumes the first value in the list as the default, and Enum types cannot be optional.
...
# ```
# pynebula run \
#   https://raw.githubusercontent.com/nebulaclouds/nebulasnacks/master/examples/data_types_and_io/data_types_and_io/enum_type.py \
