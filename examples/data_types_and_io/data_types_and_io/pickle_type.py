...
# ```
#
# Nebula enforces type safety by utilizing type information for compiling tasks and workflows,
...
# in understanding their data structures upfront before experiencing the value Nebula has to offer.
#
# Nebula supports the `NebulaPickle` transformer, which converts any unrecognized type hint into `NebulaPickle`,
...
# For optimal performance, it's advisable to either employ Python types that are supported by Nebula
...
# %% [markdown]
# `Superhero` represents a user-defined complex type that can be serialized to a pickle file by Nebulakit
...
from nebulakit.types.pickle.pickle import BatchSize
