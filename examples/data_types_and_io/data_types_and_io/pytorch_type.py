...
# ```
#
# Nebula advocates for the use of strongly-typed data to simplify the development of robust and testable pipelines.
# In addition to its application in data engineering, Nebula is primarily used for machine learning.
# To streamline the communication between Nebula tasks, particularly when dealing with tensors and models,
...
# Without native support for PyTorch tensors and modules, Nebulakit relies on {std:ref}`pickle <pickle_type>` for serializing
...
# serialization and deserialization support into the Nebula type system.
# %%
import torch
...
from nebulakit.extras.pytorch import PyTorchCheckpoint
...
# the device conversion from GPU to CPU will be automatically handled by Nebulakit.
