...
# ```
#
# Nebula allows users to access attributes directly on output promises for List, Dict, Dataclass, and combinations of these types. This allows users to pass attributes of the output directly in workflows, making it more convenient to work with complex data structures.
#
...
from nebulakit import WorkflowFailurePolicy, task, workflow
...
# :::{important}
# Currently, Nebula doesn't support accessing output promises by list slicing.
# :::
# %%
@task
