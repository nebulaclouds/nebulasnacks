...
custom_image = ImageSpec(
    name="kftensorflow-nebula-plugin",
    packages=["tensorflow", "tensorflow-datasets", "nebulakitplugins-kftensorflow"],
...
# :::
#
# The following imports are required to configure the TensorFlow cluster in Nebula.
# You can load them on demand.
# %%
if custom_image.is_container():
    import tensorflow as tf
    import tensorflow_datasets as tfds
    from nebulakitplugins.kftensorflow import PS, Chief, TfJob, Worker
...
# %% [markdown]
# To create a TensorFlow task, add {py:class}`~nebulakitplugins.kftensorflow.TfJob` config to the Nebula task.
# %%
training_outputs = NamedTuple("TrainingOutputs", accuracy=float, loss=float, model_state=NebulaDirectory)
