...
from nebulakitplugins.snowflake import SnowflakeConfig, SnowflakeTask

# %% [markdown]
# Instantiate a {py:class}`~nebulakitplugins.snowflake.SnowflakeTask` to execute a query.
# Incorporate {py:class}`~nebulakitplugins.snowflake.SnowflakeConfig` within the task to define the appropriate configuration.
# %%
...
# name within your project/domain for your Nebula installation.
# :::
#
