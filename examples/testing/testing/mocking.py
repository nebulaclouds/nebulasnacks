...
# useful to be able to locally run a workflow that calls such a task. In these instances, nebulakit provides a couple
...
import pandas
from nebulakit import SQLTask, TaskMetadata, kwtypes, task, workflow
from nebulakit.testing import patch, task_mock
...
sql = SQLTask(
    ...
    outputs=kwtypes(results=NebulaSchema),
