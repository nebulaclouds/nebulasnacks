...
# ## Code Example
#
# When a workflow reaches a specified [terminal workflow execution phase](https://github.com/nebulaclouds/nebulakit/blob/v0.16.0b7/nebulakit/core/notification.py#L10,L15),
...
# %%
from nebulakit import Email, FixedRate, LaunchPlan, PagerDuty, Slack, WorkflowExecutionPhase, task, workflow
...
# %% [markdown]
# 4. You can use pynebula register to register the launch plan and lauch it in nebulaconsole to get the notifications.
#
# ```
# pynebula register lp_notifications.py
# ```
#
...
#
# The complete set of parameters that can be used for email templating are checked in [here](https://github.com/nebulaclouds/nebulaadmin/blob/a84223dab00dfa52d8ba1ed2d057e77b6c6ab6a7/pkg/async/notifications/email.go#L18,L30).
#
