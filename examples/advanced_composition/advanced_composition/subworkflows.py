...
#
# :::{note}
# Nebula's handling of dynamic workflows necessitates the use of subworkflows.
...
# Nebula automatically prepends an attribute to the inner `n0`.
# %%
@workflow
...
# %% [markdown]
# :::{note}
# You can {ref}`chain and execute subworkflows <Chain SubWorkflows>` similar to chained nebula tasks.
# :::
...
#
# :::{tip}
# If your deployment uses {ref}`multiple Kubernetes clusters <nebula:deployment-deployment-multicluster>`, then external workflows may allow you to distribute the workload of a workflow to multiple clusters.
# :::
#
...
from nebulakit import LaunchPlan, task, workflow  # noqa: E402
