...
html_context = {
    "home_page": "https://docs.nebula.org",
}
...
html_favicon = "_static/nebula_circle_gradient_1_4x4.png"
html_logo = "_static/nebula_circle_gradient_1_4x4.png"
...
intersphinx_mapping = {
    ...
    "nebulakitplugins": ("https://docs.nebula.org/projects/nebulakit/en/latest/", None),
    "nebula": ("https://nebula.readthedocs.io/en/latest/", None),
    # Uncomment for local development and change to your username
    # "nebulakit": ("/Users/ytong/go/src/github.com/lyft/nebulakit/docs/build/html", None),
    "nebulaidl": ("https://docs.nebula.org/projects/nebulaidl/en/latest", None),
    "nebulactl": ("https://docs.nebula.org/projects/nebulactl/en/latest/", None),
