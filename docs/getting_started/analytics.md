...
Nebula is ideal for data cleaning, statistical summarization, and plotting
because with `nebulakit` you can leverage the rich Python ecosystem of data
...
from nebulakit import Deck, task, workflow, Resources
...
We can use {ref}`Nebula Decks <decks>` for rendering a static HTML report
...
## Custom Nebula Deck Renderers

You can also create your own {ref}`custom Nebula Deck renderers <getting_started_customer_renderers>`
...
If you need to connect to a database, Nebula provides first-party
