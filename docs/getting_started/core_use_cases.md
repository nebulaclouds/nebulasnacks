...
core use cases that Nebula is designed for. Within the context of these guides,
...
some practical and simple examples of how Nebula can help you in your daily
practice.
...
includes examples of Nebula in specific domains like
